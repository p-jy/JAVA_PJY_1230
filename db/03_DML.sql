...
#  - 값들 순서는 속성 순서에 맞게 넣어주어야 함.
#  - 테이블명 대신 DB명. 테이블명으로 해도 됨.
#  - DB명.테이블명으로 쓰면 선택된 DB와 상관없이 실행됨.
...
VALUES(2, 1, 1, "김길동"), (2, 1, 2, "가길동"), (2, 1, 3, "나길동"),
...
# 1학년 1반 1번의 1학년 2학기 국어 성적을 100점으로 추가하는 쿼리
...
SELECT ST_KEY, SJ_NUM FROM STUDENT
JOIN `SUBJECT`
