# 컴퓨터공학과를 등록. 학과코드: COM, 학과코드번호 160, 사무실 KH 1관 401호를 등록하는 쿼리
# 디자인공학과를 등록. 학과코드: DEG, 학과코드번호 123, 사무실 KH 3관 101호를 등록하는 쿼리
# 기계공학과를 등록. 학과코드: MEC, 학과코드번호 456, 사무실 KH 4관 201호를 등록하는 쿼리
INSERT INTO DEPARTMENT VALUES
("COM", "컴퓨터공학과", "KH 1관 401호", 160, NULL),
("DEG", "디자인공학과", "KH 3관 101호", 123, NULL),
("MEC", "기계공학과", "KH 4관 201호", 456, NULL);
...
SELECT 
    ...
    FP_NAME, FP_RES_NUM, FP_PHONE, FP_YEAR, DE_NUM, NULL
FROM
	FINAL_PASS
JOIN
	DEPARTMENT ON FP_DE_NUM = DE_NUM
WHERE
	DE_NAME = "컴퓨터공학과" AND FP_YEAR = YEAR(NOW());
