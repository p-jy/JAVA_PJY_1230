...
public class Ex06_ArraySort {
	...
	public static void main(String[] args) {
		...
		/* 버블정렬 시간복잡도 O(n^2)
		 * 1회차 - 1 3 5 7 2 4 6 8 9 10 : 10 정렬
		 * 2회차 - 1 3 5 2 4 6 7 8 9 10 : 9 정렬
		 * 3회차 - 1 3 2 4 5 6 7 8 9 10 : 8 정렬
		 */
		 ...
		 */
		Arrays.sort(arr2);
		//Arrays.toString(배열) : 배열을 문자열로 변환. [값, 값, 값, ...]
		System.out.println(Arrays.toString(arr2));
		
		Integer [] arr3 = {1, 3, 5, 7, 9, 2, 4, 6, 8, 10};
		/* 배열의 내림차순은 기본 자료형으로는 재공이 안됨. => Integer 배열을 활용
