...
public class Ex09_Object {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		// => 모든 클래스는 Object 클래스를 상속 받음 => Object 클래스에서 물려받은 toString을 가지고 있기 때문.
		System.out.println(p);
		System.out.println(p.toString());
		
//		Item item = new Item("수입", "월급", "1월 월급", 1000000, "2025-01-09");
...
@Data //= @ToString , @ToGetter , @ToSetter , @EqualsAndHashCode
class Point {
	private int x, y;
